...
<?php
$query ="SELECT * FROM store_scrapinventory_badorder_data $q ORDER BY status,id DESC";  
...
?>	
	<tbody>	
		<tr <?php echo $tr_command; ?> <?php echo $noid_class; ?>>
			...
			<td style="width:300px"><?php echo $ROWS['item_name']." ".$noid_text; ?></td> <!-- ITEM NAME -->
			<td style="text-align:right; padding-right:30px !important; width:150px"><?php echo $ROWS['actual_count']; ?></td> <!-- ITEM NAME -->
			<td style="text-align:center;width:150px"><?php echo $ROWS['units']; ?></td> <!-- ACTUAL YIELD -->
			<td colspan="3"></td>
			<td style="text-align:center; width:150px"><?php echo $status; ?></td>
