...
<?php
$query ="SELECT * FROM store_request_data $q ORDER BY status,id DESC";  
		...
		<tr <?php echo $tr_command; ?> <?php echo $noid_class; ?>>
			...
			<td style="text-align:center; padding:1px !important" class="actions">
				...
				<div>
					...
					<button class="btn btn-danger btn-sm" style="width:49%;font-size:11px" onclick="deleteItem('<?php echo $rowid; ?>','<?php echo $file_name; ?>','<?php echo $item_name; ?>')"><i class="fa-solid fa-trash"></i></button>
				</div>
				<?php }  else {?>
				<div>
