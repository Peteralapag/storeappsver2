...
<div id="tcontainer" style="position:relative;overflow:hidden">
		...
		<?php
		$queryOUT ="SELECT * FROM store_supplies_transfer_data $q ORDER BY status,id DESC";  
	...
	<div class="tin" id="tin">
		...
		<?php
		$queryIN ="SELECT * FROM store_supplies_transfer_data $iN ORDER BY status,id DESC";  
...
$(function()
{
	...
	if(isconnected == 0)
	{
		var mode = 'supplies_checktransfer';
		var params = 'supplies_transferin';
	...
	$('#posttosummarybtnIN').click(function(){
		...
		setTimeout(function()
		{	
			var mode = 'postAllSuppliesTransferIn';
