...
<div id="tcontainer" style="position:relative;overflow:hidden">
		...
		<?php
		$queryOUT ="SELECT * FROM store_scrapinventory_transfer_data $q ORDER BY status,id DESC";  
	...
	<div class="tin" id="tin">
		...
		<?php
		$queryIN ="SELECT * FROM store_scrapinventory_transfer_data $iN ORDER BY status,id DESC";  
...
$(function()
{
	...
	if(isconnected == 0)
	{
		var mode = 'scrapinventory_checktransfer';
		var params = 'scrapinventory_transferin';
