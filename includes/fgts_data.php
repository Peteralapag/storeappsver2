		...
		<tr <?php echo $tr_command; ?> <?php echo $noid_class; ?>>
			...
			<td style="text-align:center; padding:1px !important" class="actions">
				...
				<div>
					...
					<button class="btn btn-danger btn-sm" style="width:49%;font-size:11px" onclick="DeleteUserChecking('<?php echo $rowid; ?>','fgts','<?php echo $item_name; ?>')"><i class="fa-solid fa-trash"></i></button>
				</div>
				<?php }  else {?>
				<div>
