...
<?php
	...
	$query ="SELECT * FROM store_supplies_summary_data $q GROUP BY item_id"; 	
	...
	{	
		...
		$stock = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'stock_in',$db);
		$transfer_in = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'transfer_in',$db);
		$transfer_out = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'transfer_out',$db);
		$bad_order = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'bo',$db);
		$actual_count = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'actual_count',$db);
		$difference = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'difference',$db);
		$amount = $TheFunctions->suppliesInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'amount',$db);
