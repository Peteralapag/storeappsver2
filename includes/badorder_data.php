...
<?php
$query ="SELECT * FROM store_badorder_data $q ORDER BY status,id DESC";  
...
<?php } 
	...
	$breads = $functions->getBadOrderBreakdown('BREADS',$store_branch,$trans_date,$branch_shift,$db);
	$cakes = $functions->getBadOrderBreakdown('CAKES',$store_branch,$trans_date,$branch_shift,$db);
	$specials = $functions->getBadOrderBreakdown('SPECIALS',$store_branch,$trans_date,$branch_shift,$db);
	$beverages = $functions->getBadOrderBreakdown('BEVERAGES',$store_branch,$trans_date,$branch_shift,$db);	
	$bottledwater = $functions->getBadOrderBreakdown('BOTTLED WATER',$store_branch,$trans_date,$branch_shift,$db);
	$icecream = $functions->getBadOrderBreakdown('ICE CREAM',$store_branch,$trans_date,$branch_shift,$db);
	$merchandiseothers = $functions->getBadOrderBreakdown('MERCHANDISE OTHERS',$store_branch,$trans_date,$branch_shift,$db);
	$coffee = $functions->getBadOrderBreakdown('COFFEE',$store_branch,$trans_date,$branch_shift,$db);
	$milktea = $functions->getBadOrderBreakdown('MILK TEA',$store_branch,$trans_date,$branch_shift,$db);
