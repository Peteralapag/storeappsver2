...
<?php
	...
	$query ="SELECT * FROM store_boinventory_summary_data $q GROUP BY item_id"; 	
	...
	{	
		...
		$stock = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'stock_in',$db);
		$transfer_in = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'transfer_in',$db);
		$transfer_out = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'transfer_out',$db);
		$bad_order = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'bo',$db);
		$actual_count = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'actual_count',$db);
		$difference = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'difference',$db);
		$amount = $TheFunctions->boInventoryInventoryValue($selectedbranch,$item_id,$dateselectfrom,$dateselectto,'amount',$db);
