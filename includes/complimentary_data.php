...
<?php
$query ="SELECT * FROM store_complimentary_data $q ORDER BY status,id DESC";  
...
?>	
	<tbody>	
		<tr <?php echo $tr_command; ?> <?php echo $noid_class; ?>>
			...
			<td style="text-align:right; padding-right:30px !important"><?php echo $ROWS['amount']; ?></td> <!-- SHIFT -->
			<td><?php echo $ROWS['remarks']; ?></td> <!-- BAKE -->
