...
Date: 2025-06-30 10:15:58
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `store_brrr_expense_data`
-- ----------------------------
DROP TABLE IF EXISTS `store_brrr_expense_data`;
CREATE TABLE `store_brrr_expense_data` (
...
-- ----------------------------
-- Records of store_brrr_expense_data
-- ----------------------------
