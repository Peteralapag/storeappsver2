...
<table style="width: 850px" class="tables" cellpadding="4" cellspacing="15">
	...
	<tr>
		<td>
			<input id="category" type="text" class="form-control" value="SUPPLIES" disabled="disabled">
		</td>
		<td style="width:10px;"></td>
		<td>
	...
	<tr>
		...
		<td colspan="3" style="text-align:right">
			...
			<button class="btn btn-success btnnew" onclick="commitAction('new')">Save Pcount</button>
