...
<table style="width: 100%" class="tables" cellpadding="4" cellspacing="15">
	...
	<tr>
		...
		<td></td>
		<td style="width:10px;"></td>
		<td><input style="text-align:center;color:red;font-weight:bold" type="text" id="itemid" class="form-control" value="<?php echo $item_id; ?>" placeholder="Item ID" disabled></td>
	</tr>		
	<tr>
		<td></td>
		<td style="width:10px;"></td>
...
function commitAction(transmode)
{
	...
	if(item_id === '') { app_alert("ITEM ID Error","The Item Name you are trying to encode does not exists in the database. Please try again selecting what is in the dropdown list","warning","Ok","","focus"); return false; }
