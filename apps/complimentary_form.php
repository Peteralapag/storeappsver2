...
<table style="width: 850px" class="tables" cellpadding="4" cellspacing="15">
	...
	<tr>
		...
		<td style="width:10px;"></td>
		<td>
		<input id="remarks" type="text" class="form-control form-input" placeholder="Remark is optional" value="<?php echo $remarks; ?>" autocomplete="no"></td>
		<td style="width:10px;"></td>
