...
if($transmode == 'edit')
{
	...
	$total  = $functions->GetEditInfo($table,$rowid,'total',$db);
	$remarks  = $functions->GetEditInfo($table,$rowid,'remarks',$db);
...
<table style="width: 850px" class="tables" cellpadding="4" cellspacing="15">
	...
	<tr>
		<td><input id="total" type="text" class="form-control form-input" placeholder="0.00" value="<?php echo $total; ?>" autocomplete="no"></td>
		<td style="width:10px;"></td>
		<td><input id="remarks" type="text" class="form-control form-input" placeholder="Remark is optional" value="<?php echo $remarks; ?>" autocomplete="no"></td>
		<td style="width:10px;"></td>
		<td></td>
		<td style="width:10px;"></td>
		<td>
	...
	<tr>
		<td colspan="8" style="text-align:right">
			...
			<button class="btn btn-success btnnew" onclick="commitAction('new')" disabled>Save Charges</button>
...
//	else if(total <= '0' || actual_yield <= '0.00') { app_alert("Actual Yield Error","Actual Yield cannot be empty or equal to zero.","warning","Ok","actual_yield","focus"); return false; }
