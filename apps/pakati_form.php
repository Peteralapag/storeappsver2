...
<table style="width: 100%" class="tables" cellpadding="4" cellspacing="15">
	...
	<tr>
		...
		<td colspan="3" style="text-align:right">
			...
			<button class="btn btn-success btnnew" style="width:auto" onclick="commitAction('new')">
			Save PAKATI</button>
			<?php } if($transmode == 'edit') { ?>
			<button class="btn btn-info btnupdate" onclick="commitAction('edit')" style="width: auto">
			Update PAKATI</button>
			<?php } ?>
