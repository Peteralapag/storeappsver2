...
<table style="width: 100%" class="tables" cellpadding="4" cellspacing="5">
	...
	<tr>
		<td style="width: 24%">
			...
			<input id="category" type="text" class="form-control" value="SCRAP ITEMS" disabled>
		</td>		
		<td style="width: 10px">&nbsp;</td>
		<td style="width: 24%">
			<input id="rowid" type="hidden" value="<?php echo $rowid; ?>">
...
function transferToBranch(rowid)
{
	...
	var mode = 'scrapinventorytransfertobranch';
...
function commitAction(transmode)
{
	...
	if(transmode === 'new')
	{ 
		var mode = 'savescrapinventorytransfer'; 
	...
	{ 
		var mode = 'updatescrapinventorytransfer';
